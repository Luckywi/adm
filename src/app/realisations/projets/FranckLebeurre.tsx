// src/app/realisations/projets/FranckLebeurre.tsx (version adaptée mobile)
'use client';
...
export default function FranckLebeurre() {
  ...
  const schemaData = {
    ...
    "@type": "WebSite",
    "name": "Franck Lebeurre Expertise Comptable",
    "url": "https://francklebeurre-expertise.fr",
    "description": "Cabinet d'expertise comptable spécialisé dans les professions libérales.",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://francklebeurre-expertise.fr/search?q={search_term_string}",
